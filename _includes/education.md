<table id="tbPublications" width="100%" style="border: none;">
    <tbody style="border: none;">
        ...
        <td width="200" style="vertical-align: middle; padding: 20px 0; border: none;">
            <img src="assets/img/logo_polyu.png" width="95px" style="box-shadow: 4px 4px 8px #ffffff; display: block; margin: auto;">    
        </td>
        <td style="border: none; padding-left: 20px;">
            ...
            <p style="margin: 0px 0">Co-Supervisor: Prof. <a href="https://scholar.google.com/citations?user=LFngSp0AAAAJ&hl=en">Kay Chen TAN</a> (<a href="https://www.polyu.edu.hk/dsai/people/academic-staff/tankaychen/">IEEE Fellow</a>)</p>
            <p style="margin: 0px 0">Jan. 2026 - Jan. 2029 (EGD)</p>
        </td>
    </tr>
    <tr style="border: none;">
        <td width="200" style="vertical-align: middle; padding: 20px 0; border: none;">
        ...
        <td style="border: none; padding-left: 20px;">
            ...
            <p style="margin: 0px 0">Prime Supervisor: Prof. <a href="https://scholar.google.com/citations?user=cVDF1tkAAAAJ&hl=en&oi=ao">Hui Xiong</a> (<a href="https://ailab.hkust-gz.edu.cn/index.html#about">ACM/AAAS/AAAI/IEEE Fellow</a>)</p>
